...
interface SimpleTokenTimelockInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleTokenTimelock extends Contract {
  ...
  interface: SimpleTokenTimelockInterface;
